...
export const subsListGradeOpt_Array: {
   ...
   { value: "4", label: "総合国語IIIA", season: 1, midTest: true, HW: true, examPer: 80 },
   { value: "5", label: "電子回路I", season: 1, midTest: true, HW: true, examPer: 70 },
   ...
   { value: "10", label: "解析学I", season: 1, midTest: true, HW: true, examPer: 70 },
   { value: "11", label: "確率と統計", season: 1, midTest: true, HW: true, examPer: 70 },
