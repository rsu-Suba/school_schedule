...
export const subsListGradeOpt_Array: {
   ...
   { value: "4", label: "電子回路I", season: 1, midTest: true, HW: true, examPer: 70 },
   { value: "5", label: "コンピューターシステムIII", season: 1, midTest: false, HW: true, examPer: 70 },
   { value: "6", label: "総合英語III", season: 0, midTest: true, HW: true, examPer: 70 },
   { value: "7", label: "電子情報数学II", season: 1, midTest: true, HW: true, examPer: 80 },
   { value: "8", label: "アルゴリズムとデータ構造I", season: 1, midTest: true, HW: true, examPer: 80 },
   { value: "9", label: "解析学I", season: 1, midTest: true, HW: true, examPer: 70 },
   { value: "10", label: "確率と統計", season: 1, midTest: true, HW: true, examPer: 70 },
   { value: "11", label: "歴史II", season: 0, midTest: true, HW: false, examPer: 100 },
   { value: "12", label: "応用物理I", season: 1, midTest: true, HW: true, examPer: 80 },
];
